...
namespace OWZX.Core.Alipay
{
    ...
    public class AlipaySubmit
    {
        ...
        public static string BuildRequestParaToString(SortedDictionary<string, string> sParaTemp, string signType, string key, Encoding code)
        {
            //待签名请求参数数组
        ...
        /// <param name="code">字符编码</param>
        /// <returns>要请求的参数数组字符串</returns>
        public static string BuildRequestParaToStringNoSignType(SortedDictionary<string, string> sParaTemp, string signType, string key, Encoding code)
        {
            //待签名请求参数数组
            Dictionary<string, string> sPara = new Dictionary<string, string>();
            sPara = BuildRequestParaNoSignType(sParaTemp, signType, key, code);
        ...
        /// <param name="code">字符编码格式</param>
        /// <returns>要请求的参数数组</returns>
        public static Dictionary<string, string> BuildRequestParaNoSignType(SortedDictionary<string, string> sParaTemp, string signType, string key, Encoding code)
        {
            //待签名请求参数数组
            Dictionary<string, string> sPara = new Dictionary<string, string>();
            //签名结果
        ...
        /// <param name="secret">app_secret</param>
        /// <returns></returns>
        public static string SignTopRequest(SortedDictionary<string, string> parameters, string secret)
        {
            // 第一步：把字典按Key的字母顺序排序
            ...
            result = AlipayMD5.Sign(query.ToString(), secret, Encoding.UTF8);
