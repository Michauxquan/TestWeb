...
namespace OWZX.Core
{
    ...
    public partial interface IRDBSStrategy
    {
        ...
        /// <returns></returns>
        DataTable GetWebFlow(int pageNumber, int pageSize, string condition = "");
        /// <summary>
        /// 更新PV统计
        /// </summary>
        ...
        /// 更新新闻
        /// </summary>
        bool UpdateNews(NewsInfo newsInfo);
        ...
        /// </summary>
        /// <returns></returns>
        DataTable GetBaseInfoList(int baseid = -1, string condition = "");
        /// <summary>
        /// 修改基本信息
        /// </summary>
        ...
        /// <returns></returns>
        bool UpdateBaseInfo(int baseid, string title, string content);
        /// <summary>
        /// 获取基础类型
        /// </summary>
        /// <param name="condition"></param>
        /// <returns></returns>
        DataTable GetBaseTypeList(string condition="");
        /// <summary>
        /// 添加基础类型
        /// </summary>
        /// <param name="basetype"></param>
        /// <returns></returns>
        bool AddBaseType(BaseTypeModel basetype);
        ...
        /// <param name="basetype"></param>
        /// <returns></returns>
        bool UpdateBaseType(BaseTypeModel basetype);
        ...
        /// <param name="basetype"></param>
        /// <returns></returns>
        bool DeleteBaseType(int systypeid);
        #endregion
        ...
        /// <param name="remark"></param>
        /// <returns></returns>
        bool AddUserAdvice(string account, string remark);
        /// <summary>
        /// 回复意见
        /// </summary>
        /// <param name="advice"></param>
        /// <returns></returns>
        string UpdateUserAdvice(AdviceInfoModel advice);
        /// <summary>
        /// 获取意见列表
        /// </summary>
        ...
        /// <param name="condition"></param>
        /// <returns></returns>
        DataTable GetUserAdvice(int pageSize, int pageNumber, string condition = "");
        #endregion
