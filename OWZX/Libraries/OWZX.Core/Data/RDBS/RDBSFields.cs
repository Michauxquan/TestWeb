...
namespace OWZX.Core
{
    ...
    public partial class RDBSFields
    {
        ...
        /// 管理员组表
        /// </summary>
        public const string ADMIN_GROUPS = "a.[admingid],a.[title],a.[actionlist]";
        ...
        /// 开放授权表
        /// </summary>
        public const string OAUTH = "[id],[uid],[openid],[unionid],[server]";
        ...
        /// 商品图片表
        /// </summary>
        public const string PRODUCT_IMAGES = "[pimgid],[pid],[showimg],[ismain],[displayorder],[productimgs],[productdetails]";
