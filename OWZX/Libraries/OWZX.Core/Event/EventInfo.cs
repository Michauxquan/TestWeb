...
namespace OWZX.Core
{
    ...
    public class EventInfo
    {
        ...
        private int _excutetype;//执行间隔类型（1代表时，2代表分，3代表秒）
        private int _timevalue;//时间
        ...
        public DateTime? LastExecuteTime
        {
            get
            {
                ...
                {
                    _lastexecutetime = OWZX.Core.BSPData.RDBS.GetEventLastExecuteTimeByKey(_key);
                }
