...
namespace OWZX.Data
{
    ...
    public partial class AdminOperateLogs
    {
        ...
        {
            OWZX.Core.BSPData.RDBS.CreateAdminOperateLog(adminOperateLogInfo);
        }
        ...
        public static List<AdminOperateLogInfo> GetAdminOperateLogList(int pageSize, int pageNumber, string condition)
        {
            ...
            IDataReader reader = OWZX.Core.BSPData.RDBS.GetAdminOperateLogList(pageSize, pageNumber, condition);
            while (reader.Read())
            {
        ...
        {
            return OWZX.Core.BSPData.RDBS.GetAdminOperateLogListCondition(uid, operation, startTime, endTime);
        }
        ...
        {
            return OWZX.Core.BSPData.RDBS.GetAdminOperateLogCount(condition);
        }
        ...
        {
            OWZX.Core.BSPData.RDBS.DeleteAdminOperateLogById(logIdList);
        }
