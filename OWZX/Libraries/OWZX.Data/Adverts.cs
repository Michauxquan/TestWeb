...
namespace OWZX.Data
{
    ...
    public partial class Adverts
    {
        ...
        {
            return OWZX.Core.BSPData.RDBS.GetAdvertPositionCount();
        }
        ...
        {
            List<AdvertPositionInfo> advertPositionList = new List<AdvertPositionInfo>();
            IDataReader reader = OWZX.Core.BSPData.RDBS.GetAllAdvertPosition();
            while (reader.Read())
            {
                AdvertPositionInfo advertPositionInfo = BuildAdvertPositionFromReader(reader);
                advertPositionList.Add(advertPositionInfo);
        ...
        {
            OWZX.Core.BSPData.RDBS.CreateAdvertPosition(advertPositionInfo);
        }
        ...
        public static AdvertPositionInfo GetAdvertPositionById(int adPosId)
        {
            ...
            IDataReader reader = OWZX.Core.BSPData.RDBS.GetAdvertPositionById(adPosId);
            if (reader.Read())
            {
        ...
        {
            OWZX.Core.BSPData.RDBS.DeleteAdvertPositionById(adPosId);
        }
        ...
        {
            OWZX.Core.BSPData.RDBS.CreateAdvert(advertInfo);
        }
        ...
        {
            OWZX.Core.BSPData.RDBS.DeleteAdvertById(adId);
        }
        ...
        public static AdvertInfo AdminGetAdvertById(int adId)
        {
            ...
            IDataReader reader = OWZX.Core.BSPData.RDBS.AdminGetAdvertById(adId);
            if (reader.Read())
            {
        ...
        {
            return OWZX.Core.BSPData.RDBS.AdminGetAdvertList(pageSize, pageNumber, adPosId);
        }
        ...
        {
            return OWZX.Core.BSPData.RDBS.AdminGetAdvertCount(adPosId);
        }
        ...
        public static List<AdvertInfo> GetAdvertList(int adPosId, DateTime nowTime)
        {
            ...
            IDataReader reader = OWZX.Core.BSPData.RDBS.GetAdvertList(adPosId, nowTime);
            while (reader.Read())
            {
