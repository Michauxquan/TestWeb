...
namespace OWZX.Data
{
    ...
    public partial class Favorites
    {
        ...
        {
            return OWZX.Core.BSPData.RDBS.AddToFavorite(uid, pid, state, addTime);
        }
        ...
        {
            return OWZX.Core.BSPData.RDBS.DeleteFavoriteProductByUidAndPid(uid, pid);
        }
        ...
        {
            return OWZX.Core.BSPData.RDBS.IsExistFavoriteProduct(uid, pid);
        }
        ...
        {
            return OWZX.Core.BSPData.RDBS.GetFavoriteProductList(pageSize, pageNumber, uid, productName);
        }
        ...
        {
            return OWZX.Core.BSPData.RDBS.GetFavoriteProductList(pageSize, pageNumber, uid);
        }
        ...
        {
            return OWZX.Core.BSPData.RDBS.GetFavoriteProductCount(uid, productName);
        }
        ...
        {
            return OWZX.Core.BSPData.RDBS.GetFavoriteProductCount(uid);
        }
        ...
        {
            return OWZX.Core.BSPData.RDBS.SetFavoriteProductState(uid, pid, state);
        }
    }
}
