...
namespace OWZX.Data
{
    ...
    public partial class FriendLinks
    {
        ...
        {
            DataTable dt = OWZX.Core.BSPData.RDBS.GetFriendLinkList();
        ...
        {
            OWZX.Core.BSPData.RDBS.DeleteFriendLinkById(idList);
        }
        ...
        {
            OWZX.Core.BSPData.RDBS.UpdateFriendLink(friendLinkInfo);
        }
    }
}
