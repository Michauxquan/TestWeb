...
namespace OWZX.Data
{
    ...
    public partial class Helps
    {
        ...
        {
            OWZX.Core.BSPData.RDBS.CreateHelp(helpInfo);
        }
        ...
        {
            OWZX.Core.BSPData.RDBS.DeleteHelpById(id);
        }
        ...
        {
            OWZX.Core.BSPData.RDBS.UpdateHelp(helpInfo);
        }
        ...
        public static List<HelpInfo> GetHelpList()
        {
            ...
            IDataReader reader = OWZX.Core.BSPData.RDBS.GetHelpList();
        ...
        {
            return OWZX.Core.BSPData.RDBS.UpdateHelpDisplayOrder(id, displayOrder);
        }
    }
}
