...
namespace OWZX.Data
{
    ...
    public partial class Navs
    {
        ...
        public static List<NavInfo> GetNavList()
        {
            ...
            IDataReader reader = OWZX.Core.BSPData.RDBS.GetNavList();
            while (reader.Read())
            {
        ...
        {
            OWZX.Core.BSPData.RDBS.CreateNav(navInfo);
        }
        ...
        {
            OWZX.Core.BSPData.RDBS.DeleteNavById(id);
        }
        ...
        {
            OWZX.Core.BSPData.RDBS.UpdateNav(navInfo);
        }
    }
}
