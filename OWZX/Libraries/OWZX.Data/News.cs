...
namespace OWZX.Data
{
    ...
    public partial class News
    {
        ...
        {
            OWZX.Core.BSPData.RDBS.CreateNewsType(newsTypeInfo);
        }
        ...
        {
            OWZX.Core.BSPData.RDBS.DeleteNewsTypeById(newsTypeId);
        }
        ...
        public static List<NewsTypeInfo> GetNewsTypeList()
        {
            ...
            IDataReader reader = OWZX.Core.BSPData.RDBS.GetNewsTypeList();
            while (reader.Read())
            {
        ...
        {
            OWZX.Core.BSPData.RDBS.CreateNews(newsInfo);
        }
        ...
        {
            OWZX.Core.BSPData.RDBS.DeleteNewsById(newsIdList);
        }

        /// <summary>
        /// 更新新闻
        /// </summary>
        public static bool UpdateNews(NewsInfo newsInfo)
        {
           return OWZX.Core.BSPData.RDBS.UpdateNews(newsInfo);
        }
        ...
        public static NewsInfo GetNewsById(int newsId)
        {
            ...
            IDataReader reader = OWZX.Core.BSPData.RDBS.GetNewsById(newsId);
            if (reader.Read())
            {
        ...
        {
            NewsInfo newsInfo = null;
            IDataReader reader = OWZX.Core.BSPData.RDBS.AdminGetNewsById(newsId);
            if (reader.Read())
            {
                newsInfo = BuildNewsFromReader(reader);
            }
        ...
        {
            return OWZX.Core.BSPData.RDBS.AdminGetNewsList(pageSize, pageNumber, condition);
        }
        ...
        {
            return OWZX.Core.BSPData.RDBS.AdminGetNewsListCondition(newsTypeId, title);
        }
        ...
        {
            return OWZX.Core.BSPData.RDBS.AdminGetNewsCount(condition);
        }
        ...
        {
            return OWZX.Core.BSPData.RDBS.AdminGetNewsIdByTitle(title);
        }
        ...
        {
            return OWZX.Core.BSPData.RDBS.GetHomeNewsList(newsTypeId, count);
        }
        ...
        {
            return OWZX.Core.BSPData.RDBS.GetNewsListCondition(newsTypeId, title);
        }
        ...
        {
            return OWZX.Core.BSPData.RDBS.GetNewsList(pageSize, pageNumber, condition);
        }
        ...
        {
            return OWZX.Core.BSPData.RDBS.GetNewsCount(condition);
        }
    }
}
