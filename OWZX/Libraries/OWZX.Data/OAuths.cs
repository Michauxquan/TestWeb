...
namespace OWZX.Data
{
    ...
    public partial class OAuths
    {
        ...
        {
            OWZX.Core.BSPData.RDBS.CreateOAuthUser(oauthInfo);
        }
        ...
        public static int GetUidByOpenIdAndServer(string openId, string server)
        {
            int uid = -1;
                ...
                uid = OWZX.Core.BSPData.RDBS.GetUidByOpenIdAndServer(openId, server);
            return uid;
        }
        ...
        public static OAuthInfo GetOAuthUserByUid(int uid)
        {
            ...
            IDataReader reader = OWZX.Core.BSPData.RDBS.GetOAuthUserByUid(uid);
            if (reader.Read())
            {
        ...
        public static List<OAuthInfo> GetOAuthUserList(string uidList)
        {
            ...
            IDataReader reader = OWZX.Core.BSPData.RDBS.GetOAuthUserList(uidList);
            while (reader.Read())
            {
