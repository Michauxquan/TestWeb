...
namespace OWZX.Data
{
    ...
    public partial class OnlineUsers
    {
        ...
        {
            return OWZX.Core.BSPData.RDBS.CreateOnlineUser(onlineUserInfo);
        }
        ...
        {
            OWZX.Core.BSPData.RDBS.UpdateOnlineUserIP(olId, ip);
        }
        ...
        {
            OWZX.Core.BSPData.RDBS.UpdateOnlineUserUid(olId, uid);
        }
        ...
        public static OnlineUserInfo GetOnlineUserBySid(string sid)
        {
            ...
            IDataReader reader = OWZX.Core.BSPData.RDBS.GetOnlineUserBySid(sid);
            if (reader.Read())
            {
        ...
        {
            return OWZX.Core.BSPData.RDBS.GetOnlineUserCount(userType);
        }
        ...
        {
            OWZX.Core.BSPData.RDBS.DeleteOnlineUserBySid(sid);
        }
        ...
        {
            OWZX.Core.BSPData.RDBS.DeleteExpiredOnlineUser(onlineUserExpire);
        }
        ...
        {
            OWZX.Core.BSPData.RDBS.ResetOnlineUserTable();
        }
        ...
        public static List<OnlineUserInfo> GetOnlineUserList(int pageSize, int pageNumber, int locationType, int locationId)
        {
            ...
            IDataReader reader = OWZX.Core.BSPData.RDBS.GetOnlineUserList(pageSize, pageNumber, locationType, locationId);
            while (reader.Read())
            {
        ...
        {
            return OWZX.Core.BSPData.RDBS.GetOnlineUserCount(locationType, locationId);
        }
    }
}
