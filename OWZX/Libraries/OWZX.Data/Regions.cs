...
namespace OWZX.Data
{
    ...
    public partial class Regions
    {
        ...
        {
            DataTable dt = OWZX.Core.BSPData.RDBS.GetAllRegion();
        ...
        public static List<RegionInfo> GetRegionList(int parentId)
        {
            ...
            IDataReader reader = OWZX.Core.BSPData.RDBS.GetRegionList(parentId);
            while (reader.Read())
            {
        ...
        public static RegionInfo GetRegionById(int regionId)
        {
            ...
            IDataReader reader = OWZX.Core.BSPData.RDBS.GetRegionById(regionId);
            if (reader.Read())
            {
        ...
        {
            RegionInfo regionInfo = null;
            IDataReader reader = OWZX.Core.BSPData.RDBS.GetRegionByNameAndLayer(name, layer);
            if (reader.Read())
            {
                regionInfo = BuildRegionFromReader(reader);
            }
