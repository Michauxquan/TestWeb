...
namespace OWZX.Data
{
    ...
    public partial class Topics
    {
        ...
        {
            OWZX.Core.BSPData.RDBS.CreateTopic(topicInfo);
        }
        ...
        {
            OWZX.Core.BSPData.RDBS.UpdateTopic(topicInfo);
        }
        ...
        {
            OWZX.Core.BSPData.RDBS.DeleteTopicById(topicId);
        }
        ...
        public static TopicInfo AdminGetTopicById(int topicId)
        {
            ...
            IDataReader reader = OWZX.Core.BSPData.RDBS.AdminGetTopicById(topicId);
            if (reader.Read())
            {
        ...
        {
            return OWZX.Core.BSPData.RDBS.AdminGetTopicListCondition(sn, title, startTime, endTime);
        }
        ...
        {
            return OWZX.Core.BSPData.RDBS.AdminGetTopicList(pageSize, pageNumber, condition);
        }
        ...
        {
            return OWZX.Core.BSPData.RDBS.AdminGetTopicCount(condition);
        }
        ...
        {
            return OWZX.Core.BSPData.RDBS.IsExistTopicSN(topicSN);
        }
        ...
        {
            TopicInfo topicInfo = null;
            IDataReader reader = OWZX.Core.BSPData.RDBS.GetTopicByIdAndTime(topicId, nowTime);
            if (reader.Read())
            {
                topicInfo = BuildTopicFromReader(reader);
            }
        ...
        {
            TopicInfo topicInfo = null;
            IDataReader reader = OWZX.Core.BSPData.RDBS.GetTopicBySNAndTime(topicSN, nowTime);
            if (reader.Read())
            {
                topicInfo = BuildTopicFromReader(reader);
            }
