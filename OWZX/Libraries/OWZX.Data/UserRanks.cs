...
namespace OWZX.Data
{
    ...
    public partial class UserRanks
    {
        ...
        public static List<UserRankInfo> GetUserRankList()
        {
            ...
            IDataReader reader = OWZX.Core.BSPData.RDBS.GetUserRankList();
            while(reader.Read())
            {
        ...
        {
            OWZX.Core.BSPData.RDBS.DeleteUserRankById(userRid);
        }
        ...
        {
            OWZX.Core.BSPData.RDBS.UpdateUserRank(userRankInfo);
        }
    }
}
