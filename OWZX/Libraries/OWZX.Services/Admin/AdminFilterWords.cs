...
namespace OWZX.Services
{
    ...
    public partial class AdminFilterWords : FilterWords
    {
        ...
        {
            OWZX.Data.FilterWords.AddFilterWord(filterWordInfo);
        }
        ...
        {
            OWZX.Data.FilterWords.UpdateFilterWord(filterWordInfo);
        }
        ...
        public static void DeleteFilterWordById(int[] idList)
        {
            if (idList != null && idList.Length > 0)
                OWZX.Data.FilterWords.DeleteFilterWordById(CommonHelper.IntArrayToString(idList));
        }
    }
}
