...
namespace OWZX.Services
{
    ...
    public partial class AdminHelps : Helps
    {
        ...
        {
            OWZX.Data.Helps.CreateHelp(helpInfo);
            OWZX.Core.BSPCache.Remove(CacheKeys.SHOP_HELP_LIST);
        }
        ...
        public static int DeleteHelpById(int id)
        {
            ...
            if (helpInfo != null)
            {
                ...
                OWZX.Data.Helps.DeleteHelpById(id);
                OWZX.Core.BSPCache.Remove(CacheKeys.SHOP_HELP_LIST);
                return 1;
            }
            return 0;
        ...
        {
            OWZX.Data.Helps.UpdateHelp(helpInfo);
            OWZX.Core.BSPCache.Remove(CacheKeys.SHOP_HELP_LIST);
        }
        ...
        public static bool UpdateHelpDisplayOrder(int id, int displayOrder)
        {
            ...
            if (id > 0)
            {
                result = OWZX.Data.Helps.UpdateHelpDisplayOrder(id, displayOrder);
                if (result)
                    OWZX.Core.BSPCache.Remove(CacheKeys.SHOP_HELP_LIST);
            }
