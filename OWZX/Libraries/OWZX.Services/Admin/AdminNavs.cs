...
namespace OWZX.Services
{
    ...
    public partial class AdminNavs : Navs
    {
        ...
        public static void CreateNav(NavInfo navInfo)
        {
            ...
            OWZX.Data.Navs.CreateNav(navInfo);
            OWZX.Core.BSPCache.Remove(CacheKeys.SHOP_NAV_LIST);
            OWZX.Core.BSPCache.Remove(CacheKeys.SHOP_NAV_MAINLIST);
        }
        ...
        public static int DeleteNavById(int id)
        {
            ...
            OWZX.Data.Navs.DeleteNavById(id);
            OWZX.Core.BSPCache.Remove(CacheKeys.SHOP_NAV_LIST);
            OWZX.Core.BSPCache.Remove(CacheKeys.SHOP_NAV_MAINLIST);
            return 1;
        }
        ...
        public static void UpdateNav(NavInfo navInfo, int oldPid)
        {
            ...
            OWZX.Data.Navs.UpdateNav(navInfo);
