...
namespace OWZX.Services
{
    ...
    public partial class AdminOperateLogs
    {
        ...
        public static void CreateAdminOperateLog(int uid, string nickName, int adminGid, string adminGTitle, string ip, string operation, string description)
        {
            ...
            OWZX.Data.AdminOperateLogs.CreateAdminOperateLog(adminOperateLogInfo);
        }
        ...
        {
            return OWZX.Data.AdminOperateLogs.GetAdminOperateLogList(pageSize, pageNumber, condition);
        }
        ...
        {
            return OWZX.Data.AdminOperateLogs.GetAdminOperateLogListCondition(uid, operation, startTime, endTime);
        }
        ...
        {
            return OWZX.Data.AdminOperateLogs.GetAdminOperateLogCount(condition);
        }
        ...
        public static void DeleteAdminOperateLogById(int[] logIdList)
        {
            if (logIdList != null && logIdList.Length > 0)
                OWZX.Data.AdminOperateLogs.DeleteAdminOperateLogById(CommonHelper.IntArrayToString(logIdList));
        }
    }
}
