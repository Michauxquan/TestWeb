...
namespace OWZX.Services
{
    ...
    public partial class Emails
    {
        ...
        {
            //标题
            string subject = _shopconfiginfo.WebName + "找回密码邮件";
        ...
        {
            string subject = string.Format("{0}安全中心邮箱验证提醒", _shopconfiginfo.WebName);
        ...
        {
            string subject = string.Format("{0}安全中心邮箱确认提醒", _shopconfiginfo.WebName);
        ...
        {
            string subject = string.Format("恭喜您成功注册为{0}会员", _shopconfiginfo.WebName);
