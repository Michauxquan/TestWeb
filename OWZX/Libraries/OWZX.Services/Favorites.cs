...
namespace OWZX.Services
{
    ...
    public partial class Favorites
    {
        ...
        {
            return OWZX.Data.Favorites.AddToFavorite(uid, pid, state, addTime);
        }
        ...
        {
            return OWZX.Data.Favorites.DeleteFavoriteProductByUidAndPid(uid, pid);
        }
        ...
        {
            return OWZX.Data.Favorites.IsExistFavoriteProduct(uid, pid);
        }
        ...
        {
            return OWZX.Data.Favorites.GetFavoriteProductList(pageSize, pageNumber, uid, productName);
        }
        ...
        {
            return OWZX.Data.Favorites.GetFavoriteProductList(pageSize, pageNumber, uid);
        }
        ...
        {
            return OWZX.Data.Favorites.GetFavoriteProductCount(uid, productName);
        }
        ...
        {
            return OWZX.Data.Favorites.GetFavoriteProductCount(uid);
        }
        ...
        {
            return OWZX.Data.Favorites.SetFavoriteProductState(uid, pid, state);
        }
    }
}
