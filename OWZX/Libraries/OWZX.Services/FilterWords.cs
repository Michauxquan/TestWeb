...
namespace OWZX.Services
{
    ...
    public partial class FilterWords
    {
        ...
        {
            return OWZX.Data.FilterWords.GetFilterWordList();
        }
        ...
        {
            object[,] filterWordRegexList = OWZX.Core.BSPCache.Get(CacheKeys.SHOP_FILTERWORD_REGEXLIST) as object[,];
            if (filterWordRegexList == null)
            {
                ...
                OWZX.Core.BSPCache.Insert(CacheKeys.SHOP_FILTERWORD_REGEXLIST, filterWordRegexList);
            }
