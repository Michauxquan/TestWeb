...
namespace OWZX.Services
{
    ...
    public partial class OAuths
    {
        ...
        /// <returns></returns>
        public static UserInfo CreateOAuthUser(string oUserName, string uNamePrefix, string openId, string server, int regionId,string unionid)
        {
            ...
            if (uid > 0)
            {
                ...
                OWZX.Data.OAuths.CreateOAuthUser(oauthInfo);
            }
            else
            {
                userInfo = null;
        ...
        public static int GetUidByOpenIdAndServer(string openId, string server)
        {
            if (string.IsNullOrWhiteSpace(openId) || string.IsNullOrWhiteSpace(server))
                return -1;
            return OWZX.Data.OAuths.GetUidByOpenIdAndServer(openId, server);
        }
        ...
        {
            return OWZX.Data.OAuths.GetOAuthUserByUid(uid);
        }
        ...
        {
            return OWZX.Data.OAuths.GetOAuthUserList(CommonHelper.IntArrayToString(uidList));
        }
