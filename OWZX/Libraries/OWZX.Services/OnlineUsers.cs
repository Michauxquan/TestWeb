...
namespace OWZX.Services
{
    ...
    public partial class OnlineUsers
    {
        ...
        public static int CreateOnlineMember(int uid, string sid, string nickName, DateTime updateTime, string ip, int regionId)
        {
            ...
            int olid = OWZX.Data.OnlineUsers.CreateOnlineUser(onlineUserInfo);
        ...
        public static int CreateOnlineGuest(string sid, DateTime updateTime, string ip, int regionId)
        {
            ...
            return OWZX.Data.OnlineUsers.CreateOnlineUser(onlineUserInfo);
        }
        ...
        {
            OWZX.Data.OnlineUsers.UpdateOnlineUserIP(olId, ip);
        }
        ...
        {
            OWZX.Data.OnlineUsers.UpdateOnlineUserUid(olId, uid);
        }
        ...
        {
            return OWZX.Data.OnlineUsers.GetOnlineUserBySid(sid);
        }
        ...
        {
            return OWZX.Data.OnlineUsers.GetOnlineUserCount(userType);
        }
        ...
        public static int GetOnlineUserCount()
        {
            ...
            int onlineAllUserCount = TypeHelper.ObjectToInt(OWZX.Core.BSPCache.Get(CacheKeys.SHOP_ONLINEUSER_ALLUSERCOUNT), -1);
            if (onlineAllUserCount == -1)
            {
                onlineAllUserCount = GetOnlineUserCount(0);
                OWZX.Core.BSPCache.Insert(CacheKeys.SHOP_ONLINEUSER_ALLUSERCOUNT, onlineAllUserCount);
            }
        ...
        public static int GetOnlineGuestCount()
        {
            ...
            int onlineGuestCount = TypeHelper.ObjectToInt(OWZX.Core.BSPCache.Get(CacheKeys.SHOP_ONLINEUSER_GUESTCOUNT), -1);
            if (onlineGuestCount == -1)
            {
                onlineGuestCount = GetOnlineUserCount(-1);
                OWZX.Core.BSPCache.Insert(CacheKeys.SHOP_ONLINEUSER_GUESTCOUNT, onlineGuestCount);
            }
        ...
        {
            OWZX.Data.OnlineUsers.DeleteOnlineUserBySid(sid);
        }
        ...
        public static void DeleteExpiredOnlineUser()
        {
            ...
            {
                OWZX.Data.OnlineUsers.DeleteExpiredOnlineUser(BSPConfig.ShopConfig.OnlineUserExpire);
        ...
        public static void ResetOnlineUserTable()
        {
            try
            {
                OWZX.Data.OnlineUsers.ResetOnlineUserTable();
            }
            catch
            {
                try
        ...
        {
            return OWZX.Data.OnlineUsers.GetOnlineUserList(pageSize, pageNumber, locationType, locationId);
        }
        ...
        {
            return OWZX.Data.OnlineUsers.GetOnlineUserCount(locationType, locationId);
        }
    }
}
