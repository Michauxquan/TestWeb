...
namespace OWZX.Web.Controllers
{
    ...
    public class AlipayController : BaseWebController
    {
        ...
        public ActionResult Return()
        {
            ...
            //        {
            //            PluginInfo payPluginInfo = Plugins.GetPayPluginBySystemName("alipay");

            //            Orders.PayOrder(oid, OrderState.Confirming, tradeSN, DateTime.Now, payPluginInfo.SystemName, payPluginInfo.FriendlyName);
