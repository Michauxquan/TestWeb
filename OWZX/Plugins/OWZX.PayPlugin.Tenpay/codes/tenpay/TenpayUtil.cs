...
namespace OWZX.PayPlugin.Tenpay
{
    /// <summary>
    /// TenpayUtil 的摘要说明。
    /// </summary>
    public class TenpayUtil
    {
        ...
        static TenpayUtil()
        {
            ...
            tenpay_return = string.Format("http://{0}/Tenpay/Return", OWZX.Core.BSPConfig.ShopConfig.SiteUrl); ;
            tenpay_notify = string.Format("http://{0}/Tenpay/Notify", OWZX.Core.BSPConfig.ShopConfig.SiteUrl);
        }
