...
namespace OWZX.Web.Controllers
{
    public class WeChatController : BaseWebController
    {
        ...
        public ActionResult Pay()
        {
            ...
            ////付款金额
            //string totalFee = orderInfo.SurplusMoney.ToString().Replace(".", "");
            ////时间戳 
            //string timeStamp = TenpayUtil.getTimestamp();
            ////随机字符串 
            //string nonceStr = TenpayUtil.getNoncestr();
            ////服务器异步通知页面路径
            //string notifyUrl = string.Format("http://{0}/wechat/notify", BSPConfig.ShopConfig.SiteUrl);
        ...
        public ActionResult Notify()
        {
            ...
            //            {
            //                PluginInfo payPluginInfo = Plugins.GetPayPluginBySystemName("wechatpay");
            //                //if (payPluginInfo == null)
            //                //    return AjaxResult("empaypay", "请选择支付方式");
            //                Orders.PayOrder(orderInfo.Oid, OrderState.Confirming, transaction_id, DateTime.Now, payPluginInfo.SystemName, payPluginInfo.FriendlyName);
