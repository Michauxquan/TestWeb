...
namespace OWZX.Web.controllers
{
    ...
    public class NWLotteryController : BaseWebController
    {
        ...
        public ActionResult Rank() 
        {
            ...
            DataTable zdrank = MemoryCacheHelper.GetCacheItem<DataTable>("zdrank", delegate()
            {
                return ds.Tables[1];
            },
                    new TimeSpan(1,0,0,0)
                );
            DataTable weekrank = MemoryCacheHelper.GetCacheItem<DataTable>("weekrank", delegate()
            {
                return ds.Tables[2];
            },
            new TimeSpan(1, 0, 0, 0)
            ...
            ViewData["tdrank"] = tdrank; ViewData["zdrank"] = zdrank; ViewData["weekrank"] = weekrank;
            return View();
        }
        #endregion
    }
