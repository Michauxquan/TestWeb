...
function comform()
{
    ...
    if (t < minnum)
    {
        layer.alert("最小投注额[" + minnum + "]金币！", { icon: 2, title: "提示" });
        isconfirmenable = true
        return false;
    }
    else if (t > maxnum)
    ...
    {
        layer.alert("您的金币不足,请充值！", { icon: 2, title: "提示" });
        isconfirmenable = true
        return false;
    ...
    else
    {
        ...
        var message = "确认你投注？将扣除你<span id='postgoldeggs' style='color :Red;font-weight:bold'>" + t + "</span>金币！"
