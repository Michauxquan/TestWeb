...
Slider.prototype = {
  ...
  createElem: function (oParent) {
    ...
    for (var i = 0; i < this.settings.slider_num; i ++) {
        imgStr += '<a href="javascript:;" id="imga' + i + '" class="slider-item" style=" background: url(images/baseimg/hb' + (i + 1) + '.jpg) no-repeat center; ' + (i == 0 ? "display:block;" : "display:none;") + '"></a>';
  ...
  inital: function (oParent, opt) {
    ...
    this.btn_item.click(function () {
      ...
      $('#imga' + index).fadeIn(1000);
        $('#imga' + index).siblings().fadeOut(500);
      self.setDot(index);
